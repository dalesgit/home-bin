...
fromDir3="/mnt/chromeos/MyFiles/Downloads/"
...
incFrom3="/home/dale/bin/linux-config-folder.txt" 
excFrom3="/home/dale/bin/linux-hidden-files.txt"
excFrom4="/home/dale/bin/rsync-exclude4.txt"
...
echo -e "\nbacking up Crostini /home/dale -- minus various config files\n\n"
...
echo -e "\nbacking up Chromebook Downloads folder\n\n"
rsync -rvt --info=progress2  "$fromDir2"  "$toDir3/chrome"

# back up config files in Linux
echo -e "\nbacking up Linux config files\n\n"
rsync -rvt --info=progress2 --prune-empty-dirs    --exclude-from="$excFrom4"     -- "$fromDir1"	    "$toDir3/config"
